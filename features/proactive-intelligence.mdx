...
**3. Pattern detection** — Analyzes the last 30 days of knowledge graph entries to spot recurring people, projects, and tags. Feeds the patterns into Claude for interpretation — surfaces things like recurring topics that need a dedicated discussion or frequent collaborators worth noting.
