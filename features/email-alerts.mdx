...
Runs every 5 minutes. Momo triages your inbox with Claude Haiku 4.5 and pings you in Chat the moment something genuinely needs your attention — client emails, escalations, deadlines, blockers. Each alert fires once and is never duplicated. Alerted emails are also extracted into the knowledge graph for future cross-referencing.
