...
1. Runs a lightweight authenticated probe against every configured connector in parallel (Jira, Google Workspace, Google Chat, Granola, each MCP server, Anthropic, Gemini, Firestore, LangSmith)
